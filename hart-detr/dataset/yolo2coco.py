...
parser.add_argument('--image_path', default='./images/test',type=str, help="path of images")
parser.add_argument('--label_path', default='./labels/test',type=str, help="path of labels .txt")
